...
//  BipTheGuy
//
//  Created by Claudine Haigian on 9/20/20.
...
class ViewController: UIViewController {
    ...
    @IBAction func imageTapped(_ sender: UITapGestureRecognizer) {
        ...
        let smallerImageFrame = CGRect(x: imageView.frame.origin.x + widthImageShrink,
                                 y: imageView.frame.origin.y + heightImageShrink,
                                 width: imageView.frame.width - (2 * widthImageShrink),
                                 height: imageView.frame.height - (2 * heightImageShrink))
